...
=head1 FUNCTIONS
   ...
   '<<' operators has now been added.
    ...
    default rounding mode. For the '+', '-', '*', '/', '%' and '**'
    operations the precision of the returned object will be the current
    Math::MPFR default precision. For the others, the precision will be
    the same as that of the given Math::MPFR operand.
