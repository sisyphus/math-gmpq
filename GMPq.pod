...
=head1 FUNCTIONS
   ...
   The following operators are overloaded:
    ...
    Math::GMPz (or Math::GMP) objects can be used only with the
    ...
    3. If the variable is an NV, then that value is used. The
       variable is considered to be a NV if the NOK flag is set &&
       the POK flag is unset.
...
=head1 LICENSE
    ...
    Copyright 2006-2011, 2013-17, Sisyphus
