...
=head1 FUNCTIONS
   ...
   Math::GMPz objects, Math::GMP objects and Math::MPFR objects.
   ...
   '<<' operators has now been added.
    ...
    3. If the variable is a string (ie the POK flag is set) then the
       ...
       NOTE: String (PV) values given to '**' and '**=' must be +ve
             integers that fit into an unsigned long int.
    ...
    5. If the variable is a Math::GMPq object (or, for operators
       ...
       NOTE: Providing a Math::GMPq object as the exponent to the
             overloaded '**' and '**=' subroutines generates an
             error if that object does not contain a +ve integer
